Shader "Hidden/Locked/.poiyomi/Poiyomi Toon Two Pass/5305e8ed8487aab45af65b47bf3a4a73"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.0.36</color>", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						{
							vertexLighting = max(vertexLighting,lerp(poiLight.vColor[index] * poiLight.vAttenuation[index], poiLight.vColor[index] * (0.5 /*_LightingAdditivePassthrough*/) * poiLight.vAttenuation[index], smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.5 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.vDotNL[index] + .5))) * poiLight.detailShadow);
						}
					}
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalFaceMask = (1.0 /*_Decal0FaceMask*/);
				...
				Decal0.m_DecalDepth = (0.05 /*_Decal0Depth*/);
				...
				Decal1.m_DecalFaceMask = (1.0 /*_Decal1FaceMask*/);
				...
				Decal1.m_DecalDepth = (0.05 /*_Decal1Depth*/);
				...
				Decal1.m_DecalChannelSeparation = (1.18 /*_Decal1ChannelSeparation*/);
				Decal1.m_DecalChannelSeparationPremultiply = (0.0 /*_Decal1ChannelSeparationPremultiply*/);
				Decal1.m_DecalChannelSeparationHue = (0.986 /*_Decal1ChannelSeparationHue*/);
				Decal1.m_DecalChannelSeparationVertical = (1.92 /*_Decal1ChannelSeparationVertical*/);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				poiFragData.emission += lerp(0, dissolveToTexture * (9.08 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (0.0 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.5 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(unity_LightColor[index].rgb, (1.0 /*_LightingAdditiveLimit*/)) : unity_LightColor[index].rgb;
